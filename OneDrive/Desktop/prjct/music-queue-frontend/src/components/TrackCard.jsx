  ...
  return (
    <div
      ...
      className={`group bg-[rgba(0,0,0,0.1)] hover:bg-[rgba(0,0,0,0.2)] border border-[var(--aura-panel-border)]
                 ...
                 hover:scale-105 flex items-center gap-4 ${className}
    ...
    >
      {track.album?.image ? (
        <img
          ...
          alt={albumName}
          className="w-20 h-20 rounded-md object-cover flex-shrink-0" // Removed shadow-md from img, card has shadow
        />
      ) : (
        // Adjusted placeholder to match card's subtle bg
      ...
      <div className="flex flex-col items-end justify-between self-stretch ml-2">
        ...
        <button
          className="bg-[var(--aura-accent)] hover:bg-[var(--aura-accent-hover)] text-gray-900 py-2 px-3 rounded-md {/* Text color changed to text-gray-900 */}
